...
namespace Lunar.Injection.Win32
{
    public class PIMAGE_DOS_HEADER : Lunar.Injection.Types.ManagedPtr<IMAGE_DOS_HEADER>
    {
    ...
    public class PIMAGE_NT_HEADERS32 : Lunar.Injection.Types.ManagedPtr<IMAGE_NT_HEADERS32>
    {
    ...
    public class PCHAR : Lunar.Injection.Types.ManagedPtr<char>
    {
    ...
    public class PPROCESS_BASIC_INFORMATION : Lunar.Injection.Types.ManagedPtr<PROCESS_BASIC_INFORMATION>
    {
    ...
    public class PIMAGE_IMPORT_DESCRIPTOR : Lunar.Injection.Types.ManagedPtr<IMAGE_IMPORT_DESCRIPTOR>
    {
    ...
    public class PIMAGE_SECTION_HEADER : Lunar.Injection.Types.ManagedPtr<IMAGE_SECTION_HEADER>
    {
    ...
    public class PIMAGE_THUNK_DATA : Lunar.Injection.Types.ManagedPtr<IMAGE_THUNK_DATA>
    {
    ...
    public class PIMAGE_EXPORT_DIRECTORY : Lunar.Injection.Types.ManagedPtr<IMAGE_EXPORT_DIRECTORY>
    {
    ...
    public class PWORD : Lunar.Injection.Types.ManagedPtr<ushort>
    {
    ...
    public class PDWORD : Lunar.Injection.Types.ManagedPtr<uint>
    {
    ...
    public class PIMAGE_IMPORT_BY_NAME : Lunar.Injection.Types.ManagedPtr<IMAGE_IMPORT_BY_NAME>
    {
    ...
    public class PBYTE : Lunar.Injection.Types.ManagedPtr<byte>
    {
    ...
    public class PIMAGE_BASE_RELOCATION : Lunar.Injection.Types.ManagedPtr<IMAGE_BASE_RELOCATION>
    {
    ...
    public class PSHORT : Lunar.Injection.Types.ManagedPtr<short>
    {
    ...
    public class PIMAGE_TLS_DIRECTORY32 : Lunar.Injection.Types.ManagedPtr<IMAGE_TLS_DIRECTORY32>
    {
    ...
    public class PIMAGE_LOAD_CONFIG_DIRECTORY32 : Lunar.Injection.Types.ManagedPtr<IMAGE_LOAD_CONFIG_DIRECTORY32>
    {
